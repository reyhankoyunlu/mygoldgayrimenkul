...
<nav class="navbar navbar-expand-lg sticky-top navbar-dark  " style="background-color:rgba(0, 0, 0, 0.9); ">
  ...
  <div class="container-fluid">
    ...
    <a class="online" style="border: 0px; border-radius: 60px; padding: 10px 40px; background-color: #f0a500; color: black;" 
              href="tel: + 90 541 213 4040"> + 90 541 213 4040</a>
    </div>
    <!-- Right elements -->
  </div>
  <!-- Container wrapper -->
...
<div class="card text-black mb-3" style="max-width: 18rem; margin-left: 40px; background-color: #f0a500;">
  <div class="card-header">Satılık</div>
  <div class="card-body">
          ...
          <div class="modal-body">
            ...
            <table>
              ...
              <tr>
                ...
                <td><?php echo $kullanici["balkondurumu"] ?></td>
              </tr>
              <tr>
